...
- **技能默认学习日志目录**：`/var/minis/skills/self-improve/data/`
- **技能内公共学习日志目录（提升后）**：`/var/minis/skills/self-improve/data/public/`
...
- **默认记录位置**：`/var/minis/skills/self-improve/data/`
- **技能内公共区**：`/var/minis/skills/self-improve/data/public/`
...
```bash
# 默认写到技能自己的 data 目录
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh init

# 记录技能级学习
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh learning "修复了下载超时" "使用分片与重试"

# 如需明确落到项目级，再显式传 --project
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh --project /var/minis/workspace/my-project error "curl 请求失败" "HTTP 429"

# 如需直接写到技能内公共区，显式传 --public
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh --public feature "支持批量导出" "运营需要日报"

# 搜索技能区 + 项目区 + 技能内公共区
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh search 超时

# 将条目提升到技能内公共区
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh promote LRN-20260317-ABC

# 查看当前作用域
sh /var/minis/skills/self-improve/scripts/minis_auto_log.sh status
```
