#!/bin/sh
# self-improve Minis 自动初始化 + 自动记录
set -e

SKILL_BASE="/var/minis/skills/self-improve/data"
PUBLIC_BASE="/var/minis/skills/self-improve/data/public"
...
search_all() {
  ...
  find /var/minis/skills/self-improve /var/minis/workspace -type f \( -path '/var/minis/skills/self-improve/data/*.md' -o -path '/var/minis/skills/self-improve/data/public/*.md' -o -path '*/.learnings/*.md' \) -print0 2>/dev/null |
...
promote_to_public() {
  ...
  init
  SRC=$(find /var/minis/skills/self-improve /var/minis/workspace -type f \( -path '/var/minis/skills/self-improve/data/*.md' -o -path '/var/minis/skills/self-improve/data/public/*.md' -o -path '*/.learnings/*.md' \) -print0 2>/dev/null | xargs -0 grep -l "\[$ENTRY_ID\]" 2>/dev/null | head -n 1)
